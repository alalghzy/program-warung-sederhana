...
int main()
{
    ...
    do
    {
        ...
        case 2:
            ...
            do
            {
                printf(" Masukkan Menu Makanan/Minuman (3-30 karakter): ");
                scanf("%[^\n]", type);
                fflush(stdin);
            ...
            do
            {
                printf(" Masukkan Jumlah Pesanan (1-20): ");
                scanf("%d", &qty);
                fflush(stdin);
            } while (qty < 1 || qty > 20);

            printf("Sukses Menambahkan Pesanan.\n");
            push_depan(type, qty);
            getchar();
            break;
        ...
        case 3:
            ...
            do
            {
                printf("Masukkan Nomor Pesanan (1-%d): ", total);
                scanf("%d", &posisi);
                fflush(stdin);
